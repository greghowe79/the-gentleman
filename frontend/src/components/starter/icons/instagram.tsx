...
export function InstagramIcon(props: QwikIntrinsicElements['svg'], key: string) {
  return (
    <svg
    ...
    >
      ...
      >
        <path
          ...
          style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: #fcfcfc; fill-rule: nonzero; opacity: 1;"
